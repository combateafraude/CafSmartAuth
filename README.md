...
To add **CafSmartAuth 1.2.5-rc.1** to your project using **Swift Package Manager**:
...
3. In the search bar, paste the URL of this repository:
    ...
    ```
4. Select the version `1.2.5-rc.1` or choose the "Up to Next Major" option to ensure your project will automatically get future compatible updates.
